...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
  let preparationTimeInMinutesOven;
   preparationTimeInMinutesOven = preparationTimeInMinutes(numberOfLayers);
  return preparationTimeInMinutesOven + actualMinutesInOven;
